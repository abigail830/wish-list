...
import com.github.abigail830.wishlist.dto.v1.QRCodeLimitRequestDTO;
...
public class QRCodeController {
    ...
    @PostMapping(value = "/limit", produces = MediaType.IMAGE_PNG_VALUE)
    public ResponseEntity<byte[]> getQRCodeForContent(
            @RequestBody QRCodeLimitRequestDTO qrCodeLimitRequestDTO) {

        final byte[] result = qrCodeService.generate(qrCodeLimitRequestDTO.getPath(), qrCodeLimitRequestDTO.getWidth());
